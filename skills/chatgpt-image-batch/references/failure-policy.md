...
- Stop immediately.
- Tell the operator to run `npm run browser:init -- -- --app chatgpt --browser chrome --port 9222 --yes`, confirm with `npm run browser:status -- --ports 9222`, and pass `--cdp-url http://127.0.0.1:9222`.
